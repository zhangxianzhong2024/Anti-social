...
本项目旨在记录中国大陆报复社会事件（献忠、无差别袭击事件），致敬996.icu项目等优秀现实问题项目。

### 报复社会事件

报复社会事件（献忠、无差别袭击事件）指和一般故意杀人、故意伤害案件相比，没有明确的受害人指向，或者在目标受害者之外对没有明确利益指向（仇杀、情杀、劫财）同样进行杀戮的行为。包括不限于：校园劫持、开车冲撞、纵火、爆炸袭击、无差别砍人（刀战）等行为

### 注意事项

**本项目记录的事件因为当局信息封锁，伤亡数字为中国大陆当局公布伤亡数字，并非真实数字，如果需要利用本项目进行报道、研究请务必指出本问题，否则将成为虚假信息和“正确”历史记忆的帮凶。**

目前可以确定的中国大陆伤亡公布的信息封锁手段包括但不限于：

1. 死亡人数不超过35人（代表：珠海体育场撞人案）
2. 没有当场死亡的受害者，在抢救后死亡、植物人等不被计入死亡数字中，即除第一次公布死亡数字后，受伤和死亡人数不变动
3. 仅仅公布蓝底白字的警情通报，不对案件细节、作案动机进行描述
4. 警情通报中对案件进行美化，如无差别袭击、开车撞人美化为“驾车冲撞”“肇事”
5. 阻止记者采访、阻止新闻报道，仅仅允许转发警情通报或新华社、人民日报报道
6. 阻止信息流通。对自媒体热搜限流、删除词条、对转发或者主动爆料的网民进行禁言封号电话警告甚至上门传唤。
7. 对社交软件如微信中转发相关消息的群组封群、账户封号、朋友圈禁言或者在本人不知情的情况下设置为他人不可见

### 联系

目前内容来自于网友总结。尚未进行信息核查和视频图像存档，欢迎查缺补漏、提供信息或者合作编辑 gcb2999@proton.me

后续更新会加入更多爬取来自自媒体的信息，视频图片文字证据保存在子目录。数据更新请注意版本编号。

### 表格

记录表格如下文，数据利用或者转发请标注来源
...
部分数据来源于网友：[《海隅苍生｜2018-2024中国无差别杀人案件总结分析》](https://chinadigitaltimes.net/chinese/713007.html)
